...
class BoardTest {
    ...
    void testDiagonalWin() {
        Board boardDiagonalLeftToRightX = new Board(
                "X.."
              + ".X."
              + "..X"
        );
        Board boardDiagonalRightToLeftX = new Board(
                "..X"
              + ".X."
              + "X.."
        );
        ...
        Board boardDiagonalLeftToRightO = new Board(
                "O.."
              + ".O."
              + "..O"
        );
        Board boardDiagonalRightToLeftO = new Board(
                "..O"
              + ".O."
              + "O.."
        );
